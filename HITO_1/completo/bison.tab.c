...
static const yytype_uint16 yyrline[] =
{
     ...
     516,   534,   548,   554,   588,   596,   604,   612,   620,   623,
     627
};
#endif
...
void create_node_check_reg(YYSTYPE *dest, char* operator, YYSTYPE src1, YYSTYPE src2) {
...
void create_or_update_variable(char* name, char* type, YYSTYPE value, int table_index) {
