...
#line 70 ".\\bison.y"
    {
        ...
        printf("------------------------\n");
        double valor = escribir_mips((yyvsp[(1) - (1)].tr).a); 
        printf("------------------------\n");
...
#line 131 ".\\bison.y"
    {
        ...
        if (i == -1) {  
            ...
            (yyval.tr).a=nuevo_nodo('R',(yyvsp[(3) - (3)].tr).a, nodo_con_info_para_asignacion(table[i].registro));
            if((yyval.tr).a->registro==-1){
                error_compilacion++;
                printf("ERROR LINEA %d: No quedan registros disponibles para realizar la operacion asignacion\n", yylineno);
            }            
...
#line 227 ".\\bison.y"
    {
        (yyval.tr).a = (yyvsp[(1) - (1)].tr).a;
        printf("-> CONDICION\n");
        (yyval.tr).a = nuevo_nodo('C',(yyvsp[(1) - (1)].tr).a, nodo_vacio());
        if((yyval.tr).a->registro==-1){
            error_compilacion++;
            printf("ERROR LINEA %d: No quedan registros disponibles para realizar la condicion\n", yylineno);
        }
...
#line 536 ".\\bison.y"
    {
            ...
            if(i == -1){
                ...
                if(table[i].tipo=="entero"){
                    ...
                    (yyval.tr).a = nuevo_variable_hoja_numero(table[i].entero,table[i].registro);    
                }
                else if(table[i].tipo=="real"){
                    (yyval.tr).tipo = table[i].tipo;      
                    (yyval.tr).real=table[i].real;
                    //Crear nodo hoja con números
                    (yyval.tr).a = nuevo_variable_hoja_numero(table[i].real,table[i].registro);        
                }
                else if(table[i].tipo=="boolean"){
                    (yyval.tr).tipo = table[i].tipo;
                    (yyval.tr).booleano=table[i].booleano;
                    //Crear nodo hoja con booleanos
                    (yyval.tr).a = nuevo_variable_hoja_numero(table[i].booleano,table[i].registro);
                    ...
                    (yyval.tr).a = nuevo_hoja_texto(table[i].texto);
