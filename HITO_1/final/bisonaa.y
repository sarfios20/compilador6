...
program:
    statement_list  {
        ...
        printf("------------------------\n");
        double valor = escribir_mips($1.a); //$1.a->registro
...
imprimir_statement: 
    IMPRIMIR PARENTESIS_APERTURA exp PARENTESIS_CIERRE{ //imprimir un identificador
    ...
    |IDENTIFICADOR{
            ...
            if(i == -1){
                ...
                if(table[i].tipo=="entero"){
                    ...
                    $$.a = new_leaf_boolean(table[i].booleano,table[i].registro);
                    ...
                    $$.a = new_leaf_text(table[i].texto,table[i].registro);
